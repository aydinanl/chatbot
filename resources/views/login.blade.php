        ...
        <div class="white-box">
            <form class="form-horizontal form-material" id="loginform" action="/login" method="post">
                ...
                <div class="form-group m-t-40">
                    <div class="col-xs-12">
                        <input class="form-control" type="text" required="" name="username" placeholder="Kullanıcı Adı">
                    </div>
                </div>
                ...
                <div class="form-group m-b-0">
                    ...
                    <div class="col-sm-12 text-center">
                        <p>Giriş bilgileri size site ile teslim edilmiştir.</p>
                    </div>
                </div>
            </form>
            <form class="form-horizontal" id="recoverform" action="index.html">
                <div class="form-group ">
                    <div class="col-xs-12">
                        ...
                        <p class="text-muted">Emailinizi girerek şifrenizi sıfırlayabilirsiniz. <br>
                            <code>Henüz aktif değildir.</code></p>
                    </div>
                </div>
                <div class="form-group ">
                    <div class="col-xs-12">
